...
//
//        System.out.println(AlgoTwo.ansForQuery(bn2,"P(C=run|B=set,A=true)"));//input 2 query 1 0.05,2,6
//        System.out.println(AlgoTwo.ansForQuery(bn2,"P(A=true|C=run)"));//input 2 query 2 0.07429,5,12
